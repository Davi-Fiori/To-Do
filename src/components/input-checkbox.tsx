...
// Variantes para o wrapper do checkbox
export const inputCheckboxWrapperVariants = cva(`
  inline-flex items-center justify-center cursor-pointer relative group
`);

// Variantes para o próprio checkbox
export const inputCheckboxVariants = cva(
  `
    appearance-none flex items-center justify-center cursor-pointer
...
// Variantes para o ícone de check (será exibido quando o checkbox estiver marcado)
...
export default function InputCheckbox({
  ...
  return (
    <label className={inputCheckboxWrapperVariants({ className })}>
      <input
        type="checkbox"
        className={inputCheckboxVariants({ variant, size, disabled }) + " peer"}
        {...props}
      />
